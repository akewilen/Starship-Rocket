###########################################################################
## Makefile generated for component 'Attidue'. 
## 
## Makefile     : Attidue.mk
## Generated on : Sun Dec 14 22:27:45 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Attidue.exe
...
COMPILER_COMMAND_FILE     = Attidue_comp.rsp
CMD_FILE                  = Attidue.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Attidue.exe
...
DEFINES_STANDARD = -DMODEL=Attidue -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\Attidue_grt_rtw\Attidue.c $(START_DIR)\Attidue_grt_rtw\Attidue_data.c $(START_DIR)\Attidue_grt_rtw\rt_nonfinite.c
...
OBJS = rt_logging.obj Attidue.obj Attidue_data.obj rt_nonfinite.obj
...
{$(START_DIR)\Attidue_grt_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Attidue_grt_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Attidue_grt_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Attidue_grt_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Attidue.obj : "$(START_DIR)\Attidue_grt_rtw\Attidue.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Attidue_grt_rtw\Attidue.c"


Attidue_data.obj : "$(START_DIR)\Attidue_grt_rtw\Attidue_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Attidue_grt_rtw\Attidue_data.c"


rt_nonfinite.obj : "$(START_DIR)\Attidue_grt_rtw\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Attidue_grt_rtw\rt_nonfinite.c"
